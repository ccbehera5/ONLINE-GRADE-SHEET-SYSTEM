...
?>
	...
	<h1 align="center" style="color:green;">ADD NEW STUDENT</h1>
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
			...
			<input type="text" id="studname" name="studname" placeholder="Name of Student"><br /><br />
			...
			<input type="text" id="regdno" name="regdno" placeholder="Registration Number"> <br /><br />

			<label for="rollno">ROLL. NO.:</label>
			<input type="text" id="rollno" name="rollno" placeholder="Roll Number"> <br /><br />
